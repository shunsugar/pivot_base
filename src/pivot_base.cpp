...
//#endif
    ...
    goal_sub_ = nh_.subscribe("/move_base_simple/goal", 10, &PivotBase::goalCallback, this);
...
//#endif
    ...
    timer_ = nh_.createTimer(ros::Duration(0.2), &PivotBase::timerCallback, this);
  }
...
int main(int argc, char** argv){
  ...
  PivotBase pivot_base; // class_name node_name create instance?
  ros::spin();
  return 0;
}
